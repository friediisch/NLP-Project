...
train_idx = utils.balance_class(ytrain, negative_ratio=2)
test_idx = utils.balance_class(ytest, negative_ratio=2)
...
df.to_csv('../data/models/keras/results_model5.csv', sep=';', index=False)
...
model.save('../data/models/keras/model5.h5')
